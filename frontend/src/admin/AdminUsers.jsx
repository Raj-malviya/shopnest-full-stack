...
const AdminUsers = () => {
  ...
  const getJoinedDate = (userData) => {
    const dateSource = userData.createdAt || (userData._id ? parseInt(userData._id.substring(0, 8), 16) * 1000 : null);
    const joinedDate = dateSource ? new Date(dateSource) : null;
